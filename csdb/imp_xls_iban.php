...
$TBL_NoData[0]=array('ΕΠΩΝΥΜΟ','ΟΝΟΜΑ','ΑΝΑΖΗΤΗΣΗ','ΤΙΜΗ');
...
if ($choice=='cprint') { print '<H3 style="color:blue">ΚΑΤΑΧΩΡΗΘΗΚΑΝ</H3><pre>'; print_r($TBL_Data); print "</pre>"; }
print '<H3 style="color:red">ΔΕΝ ΚΑΤΑΧΩΡΗΘΗΚΑΝ</H3><pre>'; print_r($TBL_NoData); print "</pre>";
?>
</FONT>
<HR>
<A HREF="select_file.php<?php print '?appdir='.$appdir.'&appname='.$appname.'&progname='.$progname ?>">Επιστροφή<img SRC="../../media/back1.jpg" BORDER="0" ALIGN="middle"></a><BR>
